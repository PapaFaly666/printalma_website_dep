          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[20rem] xs:min-h-[24rem] sm:min-h-[28rem] lg:h-[36rem]">
            ...
            <div className="text-black flex flex-col justify-center items-center px-3 xs:px-4 sm:px-5 md:px-6 py-4 xs:py-6 sm:py-8 bg-yellow-400 text-center">
              <img
                src="/Asset 35.svg"
                alt="Design Icon"
                className="w-16 h-16 xs:w-18 xs:h-18 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 mb-3 xs:mb-4 sm:mb-5 md:mb-6"
              />
              <h3 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 xs:mb-4 sm:mb-5 md:mb-6 uppercase tracking-wide leading-tight">
                TROUVER DES DESIGNS EXCLUSIFS
              </h3>
              <p className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl mb-3 xs:mb-4 sm:mb-5 md:mb-6 leading-relaxed max-w-3xl mx-auto px-2">
