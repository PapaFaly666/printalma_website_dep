  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-start px-3 sm:px-4 pt-1 sm:pt-2 pb-2 sm:pb-4 overflow-hidden">
      ...
      <form onSubmit={handleSubmit}>
        <div className="w-full max-w-xs sm:max-w-sm bg-red-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg mb-4 sm:mb-6">
          <div className="space-y-4 sm:space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-2 sm:px-3 py-2 sm:py-2.5 rounded-md border-0 focus:outline-none focus:ring-1 focus:ring-red-700 bg-white text-xs sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-2 sm:px-3 py-2 sm:py-2.5 rounded-md border-0 focus:outline-none focus:ring-1 focus:ring-red-700 bg-white text-xs sm:text-sm pr-10"
                  placeholder="• • • • • • • •"
                />
                <button
                  type="button"
      ...
      <div className="w-full max-w-xs sm:max-w-sm">
        <button
          ...
          className="text-gray-500 text-sm hover:text-gray-700 bg-transparent border-none cursor-pointer w-full"
        >
          ← Retour à la connexion vendeur
        </button>
      </div>
      ...
      <div className="w-full max-w-xs sm:max-w-sm mt-4">
        <p className="text-xs text-gray-500 text-center">
          <span className="font-semibold">🛡️ Sécurité maximale</span><br />
          Accès tracé et enregistré
        </p>
      </div>
    </div>
  );
