...
const VendorDeletedProducts: React.FC = () => {
  ...
  useEffect(() => {
    console.log("VendorDeletedProducts - Produits supprimés:", deletedProducts.length);
  }, [deletedProducts]);
  ...
  // Dans une vraie implémentation, filtrer les produits pour n'afficher que ceux du vendeur connecté
  // Ici, nous simulons que tous les produits supprimés appartiennent au vendeur
  const vendorDeletedProducts = deletedProducts;
    ...
    try {
      ...
      if (success) {
        ...
        toast.success('Produit supprimé définitivement', {
          description: `${productToHardDelete.name} a été supprimé définitivement.`
        });
    ...
    try {
      ...
      if (result) {
        toast.success('Produit restauré', {
          description: `${result.name} a été restauré avec succès.`
        });
      }
    } catch (error: any) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Gérez vos produits supprimés temporairement
          </p>
        </div>
        ...
        <div className="p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {vendorDeletedProducts.length} produit(s) supprimé(s)
            </p>
          </div>
          ...
          {isLoading ? (
          ...
          ) : vendorDeletedProducts.length === 0 ? (
            <div className="py-12 text-center">
            ...
            <div className="border rounded-md overflow-hidden">
              <Table>
                ...
                <TableBody>
                  {vendorDeletedProducts.map((product) => (
...
export default VendorDeletedProducts; 